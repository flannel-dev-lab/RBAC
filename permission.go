...
func GrantPermission(object Object, operation Operation, name string) (bool, error) {
    return false, errors.New("Not yet implemented")
}

// (RC-32) Core RBAC: Revoke a permission from a role - must pair an object and an operation
func RevokePermission(object Object, operation Operation, name string) (bool, error) {
    return false, errors.New("Not yet implemented")
}
